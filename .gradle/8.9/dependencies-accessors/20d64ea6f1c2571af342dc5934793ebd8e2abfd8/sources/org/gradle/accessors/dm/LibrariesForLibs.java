...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    /**
     * Dependency provider for <b>lifecycleViewModel</b> with <b>androidx.lifecycle:lifecycle-viewmodel-ktx</b> coordinates and
     * with version reference <b>coroutinesLifecycleVersion</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
     ...
     * with version reference <b>okhttp3Version</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    ...
    /**
     * Dependency provider for <b>okhttp3Logging</b> with <b>com.squareup.okhttp3:logging-interceptor</b> coordinates and
     * with version reference <b>okhttp3Version</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getOkhttp3Logging() {
        return create("okhttp3Logging");
    }

    /**
     * Dependency provider for <b>retrofit2</b> with <b>com.squareup.retrofit2:retrofit</b> coordinates and
     * with version reference <b>retrofit2Version</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    ...
    /**
     * Dependency provider for <b>retrofit2GsonConverter</b> with <b>com.squareup.retrofit2:converter-gson</b> coordinates and
     * with version reference <b>retrofit2Version</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getRetrofit2GsonConverter() {
        return create("retrofit2GsonConverter");
    }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>coroutinesLifecycleVersion</b> with value <b>2.8.7</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getCoroutinesLifecycleVersion() { return getVersion("coroutinesLifecycleVersion"); }

        /**
         * Version alias <b>coroutinesVersion</b> with value <b>1.10.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>javapoetVersion</b> with value <b>1.13.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getJavapoetVersion() { return getVersion("javapoetVersion"); }
        ...
        /**
         * Version alias <b>okhttp3Version</b> with value <b>4.9.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getOkhttp3Version() { return getVersion("okhttp3Version"); }

        /**
         * Version alias <b>retrofit2Version</b> with value <b>2.11.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getRetrofit2Version() { return getVersion("retrofit2Version"); }
